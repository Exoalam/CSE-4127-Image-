...
w *= 255
structure1 = cv2.resize(structure1,(150,150),interpolation=cv2.INTER_AREA)
structure2 = cv2.resize(structure2,(150,150),interpolation=cv2.INTER_AREA)
structure3 = cv2.resize(structure3,(150,150),interpolation=cv2.INTER_AREA)
w = cv2.resize(w,(150,150),interpolation=cv2.INTER_AREA)
